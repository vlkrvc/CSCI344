...
def exercise3():
    ...
    url = f'https://www.apitutor.org/yelp/simple/v3/businesses/search?location={location}&term={search_term}&limit={count}'
...
def exercise4():
    ...
    with open('data.json') as f:
        quotes = json.load(f)
    print(quotes)
    return render_template('quote-of-the-day.html', user=current_user, quotes=quotes)
