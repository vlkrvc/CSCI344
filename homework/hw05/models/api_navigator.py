...
class ApiNavigator(object):
    def __init__(self, current_user):
        ...
        bookmark = (
            Bookmark.query.filter_by(user_id=self.current_user.id)
            .limit(1)
            .one_or_none()
        )
        like = (
            LikePost.query.filter_by(user_id=self.current_user.id)
            .limit(1)
            .one_or_none()
        )
        self.image_url = "https://picsum.photos/300/300"

        self.post_id = post.id if post else 1
        self.bookmark_id = bookmark.id if bookmark else 1
        self.like_id = like.id if like else 1
        self.comment_id = comment.id if comment else 1
        self.following_id = following.id if following else 1
        self.user_id_to_follow = self.get_user_id_to_follow()
        ...
        return {
            ...
            "Following": [
                ...
                },
                {
                    ...
                    "sample_body": json.dumps(
                        {"user_id": self.user_id_to_follow}, indent=4
                    ),
                },
                {
                    "id": "following-delete",
            ...
            "Bookmarks": [
                ...
                },
                {
                    ...
                    "sample_body": json.dumps(
                        {"post_id": self.unbookmarked_post_id}, indent=4
                    ),
                },
                {
                    "id": "bookmarks-delete",
            ...
            "Post Likes": [
                {
                    ...
                    "response_type": "List",
                    "sample_body": json.dumps(
                        {"post_id": self.unliked_post_id}, indent=4
                    ),
                },
                {
                    "id": "likes-delete",
            ...
            "Access Tokens": [
                {
                    ...
                    "endpoint": "/api/token/",
                    "endpoint_example": "/api/token/".format(
